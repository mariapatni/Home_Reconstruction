...
def create_filtered_pointcloud(points_by_frame, colors_by_frame, 
    ...
    Args:
        ...
        nb_neighbors: neighbors for statistical outlier removal
        std_ratio: std ratio for statistical outlier removal
        cluster_eps: epsilon for DBSCAN clustering
        keep_largest_n: number of largest clusters to keep
        min_cluster_size: minimum cluster size
        use_sor: whether to use statistical outlier removal
